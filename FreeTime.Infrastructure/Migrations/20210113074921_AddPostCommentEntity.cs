...
{
    public partial class AddPostCommentEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "00e09ed2-5aaf-4d9f-b6f8-5f514d6141a3", "administrator", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { 2, "7dbdb91f-9528-4625-bf6f-e4235d6d53de", "members", "member", "USER" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "3733e0c1-eeb0-4af8-ae85-684370f5693e", "admin@admin.com", false, null, false, null, "admin@admin.com", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAELLrL5A7fVUcdNzavwEGYYwhrDBPII7K7hCyzBreHV+t9x0NfuNkQfb2E1AFb6r8Ew==", null, false, "58a61ac2-d26c-46d4-8788-d43dfa3a9e54", false, "admin@admin.com" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId", "Discriminator", "RoleId1", "UserId1" },
                values: new object[] { 1, 1, "UserRole", null, null });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId", "Discriminator", "RoleId1", "UserId1" },
                values: new object[] { 2, 1, "UserRole", null, null });
